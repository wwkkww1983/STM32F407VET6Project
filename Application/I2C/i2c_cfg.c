...
#ifdef  USE_RESET_I2C
	//---保存I2C的配置
	I2Cx->msgI2CxReg.CR1 = I2Cx->pMsgI2Cx->CR1;
	I2Cx->msgI2CxReg.CR2 = I2Cx->pMsgI2Cx->CR2;
	I2Cx->msgI2CxReg.OAR1 = I2Cx->pMsgI2Cx->OAR1;
	I2Cx->msgI2CxReg.OAR2 = I2Cx->pMsgI2Cx->OAR2;
	I2Cx->msgI2CxReg.CCR = I2Cx->pMsgI2Cx->CCR;
	I2Cx->msgI2CxReg.TRISE = I2Cx->pMsgI2Cx->TRISE;
#endif
	return OK_0;
}
...
{
	(isNACK != 0) ? (LL_I2C_AcknowledgeNextData(I2Cx->pMsgI2Cx, LL_I2C_NACK)) : (LL_I2C_AcknowledgeNextData(I2Cx->pMsgI2Cx, LL_I2C_ACK));
	return OK_0;
}
...
UINT8_T I2C_MHW_CheckBusy(I2C_HandleType* I2Cx)
{
	...
	if(_return!=OK_0)
	{
		...
		//---清除复位
		LL_I2C_DisableReset(I2Cx->pMsgI2Cx);
		I2Cx->pMsgI2Cx->CR1	=I2Cx->msgI2CxReg.CR1	;
		I2Cx->pMsgI2Cx->CR2  =I2Cx->msgI2CxReg.CR2	;
		I2Cx->pMsgI2Cx->OAR1	=I2Cx->msgI2CxReg.OAR1	;
		I2Cx->pMsgI2Cx->OAR2	=I2Cx->msgI2CxReg.OAR2	;
		I2Cx->pMsgI2Cx->CCR	=I2Cx->msgI2CxReg.CCR	;
		I2Cx->pMsgI2Cx->TRISE=I2Cx->msgI2CxReg.TRISE	;
	#endif
	}
	return _return;
}
